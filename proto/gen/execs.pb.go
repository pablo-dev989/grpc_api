...
type UpdatePasswordResponse struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	PasswordUpdate bool                   `protobuf:"varint,1,opt,name=password_update,json=passwordUpdate,proto3" json:"password_update,omitempty"`
...
func (x *UpdatePasswordResponse) GetPasswordUpdate() bool {
	if x != nil {
		return x.PasswordUpdate
	}
	return false
}
...
type ExecLogoutResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	LogedOut      bool                   `protobuf:"varint,1,opt,name=loged_out,json=logedOut,proto3" json:"loged_out,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ExecLogoutResponse) GetLogedOut() bool {
	if x != nil {
		return x.LogedOut
	}
	return false
...
const file_execs_proto_rawDesc = "" +
	...
	"\x10confirm_password\x18\x03 \x01(\tR\x0fconfirmPassword\"W\n" +
	"\x16UpdatePasswordResponse\x12'\n" +
	"\x0fpassword_update\x18\x01 \x01(\bR\x0epasswordUpdate\x12\x14\n" +
	...
	"\x12ExecLogoutResponse\x12\x1b\n" +
	"\tloged_out\x18\x01 \x01(\bR\blogedOut\"\x0e\n" +
	"\fEmptyRequest\"A\n" +
